...
int main(){
    test1();
	//std::cout << "Retour au main 1" << std::endl;
    test2();
	//std::cout << "Retour au main 2" << std::endl;
    return 0;
}
...
void test2(){
    ...
    file2.enfiler(20);
    file2.enfiler(21);
	//std::cout << "Test A Fonction 2" << std::endl;
    file2 = file1;
    file1.enfiler(10);
