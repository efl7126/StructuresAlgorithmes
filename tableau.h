...
class Tableau{
  ...
  public:
	...
	// Permet de trier un tableau de pointeurs en fonction d'un attribut des 
	// objets pointés. L'objectif pour le TP1 est de trier les stations en 
	// fonction du temps de marche point d'origine -> station sans avoir à 
	// déplacer les objets Station mêmes.
  ...
  private:
    ...
    // Redimensionnement du tableau lorsque la capacité est atteinte
 	...
 	// Implémentation du tri rapide pour trier un tableau de pointeurs en 
 	// fonction de l'attribut tempsMarche1 des objets Station pointés.
...
// de l'attribut tempsMarche1 des objets Station pointés. L'implémentation du 
// tri rapide est tirée de la diapositive 27 de la présentation
// PowerPoint INF3105 - Analyse et complexité algorithmique.
template <class T>
void Tableau<T>::triRapidePointeursTempsMarche1(T *tab, int n)
{
	...
	for(int i = 1; i < n; i++)
		// Comparaison des temps de marche du point d'origine jusqu'à la 
		// première station
